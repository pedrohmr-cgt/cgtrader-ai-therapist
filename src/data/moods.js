const moods = {
  neutral: [
    "It seems that work is not giving you joy at this moment - you might need some inspiration or just a good Joke",
  ...
  happy: [
    "You are having Fun! Or using some drugs which is it? In any case share it with your team :)",
    "Remember this awesome feeling when you feel down! :)",
  ],
  sad: [
    // "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRW7YRNOfVqdzuD0O73aDHw5SkCW1GsCyNgEmISF5IH5wOl0oK_V2Kvn6Vm3sQKq7P0fEg&usqp=CAU",
    "Remember, it will get better. It will. It will. I promise it will! If we believe it, it will. Right?",
  ],
  angry: [
    "Take a deep breath!\n" +
      ...
      "\n" +
      "Talk to CGTherapist longer -> 60s session",
    "Go for a walk and clear your mind. It is okay to take a break sometimes.",
  ],
  fearful: [
    "What is that scares you now?",
  ...
  surprised: [
    "Do not be surprised - things happen and this is not a last time :) Make the best of it",
  ],
};
